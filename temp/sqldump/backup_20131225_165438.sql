...
INSERT INTO `crm_users` ( `user_id`, `email`, `user_name`, `password`, `question`, `answer`, `sex`, `birthday`, `address_id`, `reg_time`, `last_login`, `last_time`, `last_ip`, `visit_count`, `is_special`, `msn`, `qq`, `office_phone`, `home_phone`, `mobile_phone`, `is_validated`, `passwd_question`, `passwd_answer`, `enabled`, `role_id` ) VALUES  ('10006', 'c@c.com', 'admin', 'e10adc3', '', '', '0', '2013-12-17', '0', '2013-12-17 15:33:25', '1', '2013-12-25 14:17:03', '127.0.0.1', '185', '0', '', '', '', '', '', '0', '', '', '1', '1');

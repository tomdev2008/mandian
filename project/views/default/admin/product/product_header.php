                            ...
                            <div class="tabs-wrap" style="margin-left: 0px; margin-right: 0px; width: 5004px;">
                                <ul class="tabs" style="height: 26px;">
                                    <?php if(empty($pro_id)){ ?>
                                        ...
                                        <li class="">
                                            <a class="tabs-inner" href="javascript:" style="height: 25px; line-height: 25px;">
                                                <span class="tabs-title">产品详情</span></a>
                                        </li>
                                        <li class="">
                                            <a class="tabs-inner" href="javascript:" style="height: 25px; line-height: 25px;">
                                    ...
                                    <?php }else{ ?>
                                        <li class="<?php if($t == 'basic_info'){ echo 'tabs-selected';} ?>">
                                            <a class="tabs-inner" href="<?php echo for_url('admin','product','basic_info', array($pro_id)); ?>" style="height: 25px; line-height: 25px;">
                                                <span class="tabs-title">基本信息</span>
                                            </a
                                        </li>
                                        <li class="<?php if($t == 'pro_details'){ echo 'tabs-selected';} ?>">
                                            <a class="tabs-inner" href="<?php echo for_url('admin','product','pro_details', array($pro_id)); ?>" style="height: 25px; line-height: 25px;">
                                                <span class="tabs-title">产品详情</span></a>
                                        </li>
                                        <li class="<?php if($t == 'refer_trip'){ echo 'tabs-selected';} ?>">
                                            <a class="tabs-inner" href="<?php echo for_url('admin','product','refer_trip', array($pro_id)); ?>" style="height: 25px; line-height: 25px;">
                                                <span class="tabs-title">参考行程</span></a>
                                        </li>
                                        <li class="<?php if($t == 'trip_price'){ echo 'tabs-selected';} ?>">
                                            <a class="tabs-inner" href="<?php echo for_url('admin','product','trip_price', array($pro_id)); ?>" style="height: 25px; line-height: 25px;">
                                                <span class="tabs-title">价格/库存</span>
                                            </a>
                                        </li>
                                        <li class="<?php if($t == 'other_info'){ echo 'tabs-selected';} ?>">
                                            <a class="tabs-inner" href="<?php echo for_url('admin','product','other_info', array($pro_id)); ?>" style="height: 25px; line-height: 25px;">
                                                <span class="tabs-title">其他信息</span>
                                            </a>
                                        </li>
                                    <?php } ?>

            ...
            <tr>
                ...
                <td colspan="2">
                    <div id="p" class="easyui-panel" title="只能选择一个图片" style="width:560px;padding:5px;">
                        <p>
                            <a href="javascript:picHelper.flashuploadMain();" id="add-com" class="btn">添加图片</a>[双击删除图片]
            ...
            <tr>
                ...
                <td colspan="2">
                    <div id="p" class="easyui-panel" title="可选择多图片" style="width:560px;padding:5px;">
                        <p>
                            <a href="javascript:picHelper.flashuploadSub();" id="add-com" class="btn">添加图片</a>[双击删除图片]

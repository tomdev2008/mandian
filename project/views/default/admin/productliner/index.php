        ...
        <tr>
            <td>
                <div class="explain-col">
                    <input onclick="location.href = '<?php echo for_url('admin','liner','edit')?>';" type="submit" value="添加邮轮" class="btn btn-success" name="search">
                </div>
            </td>
        </tr>
        </tbody>
...
<script>
    function del(id){
        _confirm('确认删除？',function(){
            location.href = '<?php echo for_url('admin','productliner','del'); ?>' + id;
        });
    }
</script>

                                ...
                                <ul class="tabs" style="height: 26px;">
                                    ...
                                    <?php }else{ ?>
                                        <li class="<?php if($t == 'basic_info'){ echo 'tabs-selected';} ?>">
                                            <a class="tabs-inner" href="<?php echo for_url('admin','productliner','basic_info', array($pro_id)); ?>" style="height: 25px; line-height: 25px;">
                                                <span class="tabs-title">基本信息</span>
                                            </a
                                        </li>
                                        <li class="<?php if($t == 'refer_trip'){ echo 'tabs-selected';} ?>">
                                            <a class="tabs-inner" href="<?php echo for_url('admin','productliner','refer_trip', array($pro_id)); ?>" style="height: 25px; line-height: 25px;">
                                                <span class="tabs-title">参考行程</span></a>
                                        </li>
                                        <li class="<?php if($t == 'trip_price'){ echo 'tabs-selected';} ?>">
                                            <a class="tabs-inner" href="<?php echo for_url('admin','productliner','trip_price', array($pro_id)); ?>" style="height: 25px; line-height: 25px;">
                                                <span class="tabs-title">价格/库存</span>
                                            </a>
                                        </li>
                                        <li class="<?php if($t == 'other_info'){ echo 'tabs-selected';} ?>">
                                            <a class="tabs-inner" href="<?php echo for_url('admin','productliner','other_info', array($pro_id)); ?>" style="height: 25px; line-height: 25px;">
                                                <span class="tabs-title">其他信息</span>
                                            </a>
                                        </li>
                                    <?php } ?>

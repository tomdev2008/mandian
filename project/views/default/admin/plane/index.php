...
<body>
        ...
        <tr>
            <td>
                <div class="explain-col">
                    <input onclick="location.href = '<?php echo for_url('admin','plane','edit')?>';" type="submit" value="添加航班" class="btn btn-success" name="search">
                </div>
            </td>
        </tr>
        </tbody>
    ...
    <table class="table-list" width="100%">
        ...
        foreach($rows as $val){
            ...
            echo '<td>';
            echo '<a href="',for_url('admin','plane','edit', array($val['plane_id'])), '" title="Edit">[编辑]</a>&nbsp;';
...
<script>
    function del(id){
        _confirm('确认删除？',function(){
            location.href = '<?php echo for_url('admin','plane','del'); ?>' + id;
        });
    }
</script>

...
<!-- Main Content Section with everything -->
    ...
    <ul class="shortcut-buttons-set">
        <li><a class="shortcut-button" href="<?php echo for_url('system','user','user_add') ?>"><span> <img src="/public/resource/images/icons/pencil_48.png" alt="icon" /><br />
        添加新用户 </span></a></li>
            ...
            <table>
                ...
                <?php
                    foreach($rows as $val){
                        ...
                        echo '<a href="',for_url('system','system','system_role/'.$val['user_id']), '" title="Edit Meta">[角色关联]</a>';
                        echo '</td>';
                        echo '</tr>';
                    }
                ?>
